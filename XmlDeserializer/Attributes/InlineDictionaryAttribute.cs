...
{
    public class InlineDictionaryXPathAttribute : AbstractDictionaryXPathAttribute
    {
        public string XPath { get; private set; }
        public string EntrySeparator { get; private set; }
        public string KeyValueSeparator { get; private set; }

        public InlineDictionaryXPathAttribute(string xpath, string entrySeparator, string keyValueSeparator)
        {
            this.XPath = xpath;
